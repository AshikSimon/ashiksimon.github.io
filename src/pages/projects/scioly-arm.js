...
import { photos } from "../../srcsets/scioly-arm-images"
import sciolyarmVideo from "../../images/projects/sciolyarm/sciolyarm-video.mp4"

const ProjectSummary = () => (
  <Layout>
    <SEO title="Science Olympiad Robot Arm" />
    <div className="project-summary pt-4" id="page-container">
      <div id="project-content-wrap">
        <div className="container p-5">
          <div className="row justify-content-center pt-5 pb-5">
            <div className="col-md-12 text-center">
              <h1>Science Olympiad Robot Arm</h1>
            </div>
          </div>
          ...
          <video controls loop muted>
            <source src={sciolyarmVideo} type="video/mp4" />
